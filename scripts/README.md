...
The `08_chemical_equivalence.py` filename is retained for compatibility. Its
public Step08 operation is ligand contact-unit grouping and candidate selection.
