...
atom-level GED classes. Existing YAML files that use older compatibility fields
remain readable; hidden values are preserved when the GUI saves the project.
