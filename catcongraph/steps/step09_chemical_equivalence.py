...
def parse_ligand_atoms_from_pdb(path: Path) -> Tuple[List[LigAtom], Dict[int, Set[int]]]:
    ...
    Hydrogen and deuterium are not ligand contact units in AF2-CatGraph, so they
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ap = argparse.ArgumentParser(description="Ligand contact-unit grouping and common/rare interaction screening.")
