...
This module integrates the user's previous GED.py workflow into CatConGraph while
...
def get_project_root(config_path: Path) -> Path:
    # In CatConGraph examples config lives at projects/<target>/config.yaml.
...
def resolve_ged_executable(
    ...
    # 2) Check the path exactly as configured, plus CatConGraph-root and cwd-relative variants.
