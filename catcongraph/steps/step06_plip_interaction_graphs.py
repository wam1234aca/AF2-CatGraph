...
workflow into CatConGraph while keeping the classification-critical PLIP
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    parser = argparse.ArgumentParser(description="CatConGraph Step06: run PLIP and build interaction graph/GED files.")
