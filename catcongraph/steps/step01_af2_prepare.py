...
def main(argv: list[str] | None = None) -> None:
    ...
    print("[CatConGraph] Step 01 completed.")
    print(f"[CatConGraph] target_id: {report['target_id']}")
    print(f"[CatConGraph] input PDB files: {report['n_input_pdb']}")
    print(f"[CatConGraph] passed global pLDDT: {report['n_passed_global_plddt']}")
    print(f"[CatConGraph] failed/unreadable: {report['n_failed_global_plddt_or_error']}")
    print(f"[CatConGraph] output: {report['output_dir']}")
