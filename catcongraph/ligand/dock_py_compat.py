...
"""Adapter for the template-guided rigid docking implementation.
...
workflow work needed by AF2-CatGraph: choose input files from config, call the
    ...
    *,
    ...
    try:
        ...
        try:
            ...
            # Use the established docking geometry implementation.
